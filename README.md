...
<img width="209" height="235" alt="Gemini_Generated_Image_kaft24kaft24kaft" src="https://github.com/user-attachments/assets/85265e89-d0ee-4689-ac57-15d291d25ad3" />
...
- **Infrastructure & Cloud**: ![AWS](https://img.shields.io/badge/AWS-232F3E?style=flat&logo=amazonwebservices&logoColor=white) ![Nginx](https://img.shields.io/badge/Nginx-009639?style=flat&logo=nginx&logoColor=white)
...
|------|---|---|---|---|
| M.S. | UST-ETRI | Language Intelligence Research Lab, Intelligent Information Research Divison, AI Creative Research Institute | Automated Essay Scoring(AES), Video-based Intelligent Tutoring Systems |2025-03-01 ~ |
...
- M.S. in Artificial Intelligence, UST(University of Science & Technology)-ETRI(Electronics and Telecommunications Research Institute) (2025.03 - current)
  - Advisor : Prof. Jinxia Huang 
- B.S. in Data Science, University of Suwon (2018.02 - 2024.08)
  - GPA 3.99/4.5
...
- Conference Proceedings 
  - [Deepsleep2](https://github.com/whatareyoudoingz/DeepSleep_project) @ KSC2023
    - J. Kim, C. Choi, and S. Hong, “Based on life log and sleep tech device Machine learning research on sleep quality indicators”, in Proc. Korea Software Congress (KSC 2023), Korean Institute of Information Scientists and Engineers (KIISE), Dec. 2023, pp. 1627–1629.
  - [Deepsleep](https://github.com/whatareyoudoingz/ETRI-lifelog-data-project) @ ETRI 2nd Human-Understanding AI Paper Competition & KCC2023
    - J. Kim, J. Lim, and S. Hong, “A Study on Important Factors in the Estimating of  Sleep Quality Using LifeLog Data” in Proc. Korean Computer Congress (KCC 2023), Korean Institute of Information Scientists and Engineers (KIISE), Jun. 2023, pp. 2070–2072.  
  - [DataScience Syndrome] @ KSC2022
    - S. Kim, H. Seo, J. Kim, W. Jo, and H. Ahn, “Comparison of machine learning and statistical analysis for important variable selection of metabolic syndrome on the Korea National Health and Nutrition Examination Survey data,” in Proc. Korea Software Congress (KSC 2022), Korean Institute of Information Scientists and Engineers (KIISE), Dec. 2022, pp. 702–704.
- Journal Articles : NA
...
- [BDA 5th Introductory Data Analysis Course)](https://github.com/user-attachments/files/16530391/_._.pdf) @ BDA(Big Data Analytics Association) 
- [Data Science Practical Skills Enhancement Program](https://github.com/user-attachments/files/16530247/43-.0031-000385.-.1.pdf) @ DACON & University of Suwon 
  
### Hackathon🌱
- [Recycle-project](https://github.com/user-attachments/files/16530219/43-.0031-000385.-.3.pdf) - Recycling object detection & contamination classification @ Prometheus Startup Hackaton 2023
...
- Team
  ...
  - [Encouragement Award (Research Data Analysis & Utilization Competition)](https://github.com/user-attachments/files/16530258/43-.0031-000385.-.2.pdf) @ KISTI 2022

### Additional Activites⚡
- Mentor / Teaching Assistant [f-killer mentoring mentor](https://github.com/whatareyoudoingz/f-killer) @ University of Suwon
